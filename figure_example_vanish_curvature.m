...
%
% Generate Demonstration Figure/Vanishing Curvature
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
center = [0, 0];
rho = 0.75;
pts = [(rho.* abs(cos(angles))).^0.5 .* sign(cos(angles)); rho.*sin(angles)]';
for i = 1:M
...
exportgraphics(gca,'vanish.png','Resolution',300);
close all;
